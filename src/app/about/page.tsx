            ...
            <div className="about-team">
              ...
              <div className="about-team-member">
                ...
                <div className="about-team-info">
                  ...
                  <p>
                    Freek is the program editor at BlockPhi, responsible
                    for production and editorial across all shows and published
                    research.
                  </p>
                  <div className="about-team-socials">
                    <a href="mailto:contact@blockphi.com" aria-label="Email Freek Jansen">
            ...
            <div className="about-team">
              ...
              <div className="about-team-member">
                ...
                <div className="about-team-info">
                  ...
                  <div className="about-team-socials">
                    <a href="mailto:contact@blockphi.com" aria-label="Contact about George1Trader">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
                        <rect x="2" y="4" width="20" height="16" rx="2"/>
                        <path d="M22 4L12 13L2 4"/>
                      </svg>
